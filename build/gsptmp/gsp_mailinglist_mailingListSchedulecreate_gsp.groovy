...
class gsp_mailinglist_mailingListSchedulecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mailingListSchedule/create.gsp" }
public Object run() {
Writer out = getOut()
