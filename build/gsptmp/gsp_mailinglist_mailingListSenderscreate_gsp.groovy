...
class gsp_mailinglist_mailingListSenderscreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mailingListSenders/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(2)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'mailingListSenders.label', default: 'MailingListSenders'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(mailingListSendersInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(mailingListSendersInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
