...
class gsp_mailinglist_mailingListScheduleedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mailingListSchedule/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',25,['bean':(mailingListScheduleInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',27,['bean':(mailingListScheduleInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
invokeTag('hiddenField','g',29,['name':("id"),'value':(mailingListScheduleInstance?.id)],-1)
printHtmlPart(18)
invokeTag('hiddenField','g',30,['name':("version"),'value':(mailingListScheduleInstance?.version)],-1)
printHtmlPart(19)
