...
<html>
	...
	<body>
		<a href="#edit-mailingListAttachments" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default=""/></a>
		...
		<div id="edit-mailingListAttachments" class="content scaffold-edit" role="main">
