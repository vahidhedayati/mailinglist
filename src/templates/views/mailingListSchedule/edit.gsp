...
<html>
	...
	<body>
		<a href="#edit-mailingListSchedule" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default=""/></a>
		...
		<div id="edit-mailingListSchedule" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${mailingListScheduleInstance?.version}" />
				<fieldset class="form">
