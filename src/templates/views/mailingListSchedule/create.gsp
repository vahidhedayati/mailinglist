...
<html>
	...
	<body>
		<a href="#create-mailingListSchedule" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default=""/></a>
		...
		<div id="create-mailingListSchedule" class="content scaffold-create" role="main">
