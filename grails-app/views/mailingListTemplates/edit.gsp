...
<html>
	...
	<body>
		<a href="#edit-mailingListTemplates" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default=""/></a>
		...
		<div id="edit-mailingListTemplates" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${mailingListTemplatesInstance?.version}" />
				<fieldset class="form">
