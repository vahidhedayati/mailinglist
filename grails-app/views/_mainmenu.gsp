 ...
 <ul id="mailMenu" class="nav-pills">
		...
		<li><g:link controller="MailingListSchedule"  class="btn btn-primary" action="br" params="${[s:'oa',viewtype:'na']}"><g:message code="default.schedule.label" default="Schedule Logs"/></g:link></li>
