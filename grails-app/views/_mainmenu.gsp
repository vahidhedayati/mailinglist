 ...
 <ul class="nav-pills">
		...
		<li class="btn btn-info"><g:link controller="MailingListSchedule"  action="br" params="${[s:'oa',viewtype:'na']}"><g:message code="default.schedule.label" default="Schedule Logs"/></g:link></li>
