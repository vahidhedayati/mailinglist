...
<div class="fieldcontain ${hasErrors(bean: mailingListInstance, field: 'mlcategories', 'error')} required">
	<label for="mlcategories">
		<g:message code="mailingList.mlcategories.label" default="Mlcategories" />
		<span class="required-indicator">*</span>
	</label>
	<g:select id="mlcategories" name="mlcategories.id" from="${kportal.MailingListCat.list()}" optionKey="id" required="" value="${mailingListInstance?.mlcategories?.id}" class="many-to-one"/>
</div>
