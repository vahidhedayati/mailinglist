...
<html>
	...
	<body>
		<a href="#show-mailingList" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default=""/></a>
		...
		<div id="show-mailingList" class="content scaffold-show" role="main">
			...
			<ol class="property-list mailingList">
				...
				<g:if test="${mailingListInstance?.mlcategories}">
				<li class="fieldcontain">
					<span id="mlcategories-label" class="property-label"><g:message code="mailingList.mlcategories.label" default="Mlcategories" /></span>
					
						<span class="property-value" aria-labelledby="mlcategories-label"><g:link controller="mailingListCat" action="show" id="${mailingListInstance?.mlcategories?.id}">${mailingListInstance?.mlcategories?.encodeAsHTML()}</g:link></span>
