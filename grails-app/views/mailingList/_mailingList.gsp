...
<div id="the_box" role="complementary">
	...
	<ul><li><div class="internalbtn">		
		...
		<div id="mailinglistcat-logo"><div class=app-detail><h4>Categories (Binds to Email Address)</h4></div></div>
			<div class="internalbtn"><g:link controller="MailingListCat" class="create" action="create"><g:message code="Create Category" args="[entityName]" /></g:link></div>
			<div class="internalbtn"><g:link controller="MailingListCat" class="list" action="list"><g:message code="List Categories" args="[entityName]" /></g:link></div>
