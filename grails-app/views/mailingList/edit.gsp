...
<html>
	...
	<body>
		<a href="#edit-mailingList" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default=""/></a>
		...
		<div id="edit-mailingList" class="content scaffold-edit" role="main">
